...
implementation
    ...
    begin
      ...
      writeln('| EMB120 | Maputo | Quelimane|   TM2135  |  18:30  |  19:40  |  3F / 5F       | 1046MZN |');
      ...
      writeln('| EMB120 | maputo | Vilankulo|   TM2135  |  15:15  |  16:25  |  5F            | 5041MZN |');
      ...
      writeln('| EMB190 | maputo | Niassa   |   TM2156  |  11:30  |  13:15  |  3F / 4F / 6F  | 2360MZN |');
      writeln('| B772-5 | maputo | Niassa   |   TM2156  |  11:30  |  13:15  |  4F / SAB      | 3490MZN |');
      writeln('| B737-9 | maputo | Niassa   |   TM2156  |  11:30  |  13:15  |  2F / 3F       | 4160MZN |');
      writeln('| Q400   | maputo | Niassa   |   TM2156  |  11:30  |  13:15  |  3F / 5F       | 7000MZN |');
      writeln('| EMB190 | maputo | Niassa   |   TM2156  |  11:30  |  13:15  |  5F / 6F       | 2367MZN |');
      writeln('| EMB120 | maputo | Niassa   |   TM2156  |  11:30  |  13:15  |  6F /SAB /DOM  | 4567MZN |');
      writeln('+========+========+==========+===========+=========+=========+================+=========+');
	end;
    ...
    begin
      ...
      writeln('| EMB145 | Nacala - NCL | Harare      - HRA |   NH3100  |  07:00  |  08:10  |  3F / 5F       | 4786MZN |');
      writeln('| EMB120 | Nacala - NCL | Lusaka      - LUN |   NL2135  |  18:30  |  19:40  |  3F / 5F       | 1046MZN |');
      ...
      writeln('| Q400   | Maputo - MPT | Dubai       - DXB |   MD4015  |  15:15  |  17:00  |  6F            | 5491MZN |');
      writeln('| EMB190 | Beira  - BRA | Guangzhou   - CAN |   BG6754  |  17:20  |  19:05  |  SAB / DOM     | 4522MZN |');
      writeln('| EMB120 | Maputo - MPT | Bangkok     - BKK |   MB3456  |  15:15  |  16:25  |  5F            | 5041MZN |');
      writeln('| EMB145 | Maputo - MPT | Nairobi     - NBO |   MN9087  |  18:30  |         |  DOM           | 5313MZN |');
      writeln('| EMB145 | Beira  - BRA | Harare      - HRA |   BH4738  |  11:30  |  13:15  |  SAB e DOM     | 1757MZN |');
      writeln('| EMB190 | Beira  - BRA | Joanesburgo - JNB |   BJ3485  |  11:30  |  13:15  |  3F / 4F / 6F  | 2360MZN |');
      writeln('+========+==============+===================+===========+=========+=========+================+=========+');
	end;
